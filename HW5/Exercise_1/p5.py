...
def main():
    ...
    # train the model
    # model, history = train_model(model, dataloaders, dataset_sizes, loss_func, optimizer, scheduler, device, num_epochs=25)
    ...
    # model, history = train_model(model, dataloaders, dataset_sizes, loss_func, optimizer, device, num_epochs=50,
    #                              start_epoch=26, history=history)
